...
const DEMO_MATERIALS = [
  { id: 'demo-rat', name: 'RAT', price: 3.20, weight: 0, volume: 0, discountPercent: 0, showOnOrderList: true, cxPrice: null, category: 'food' },
  { id: 'demo-dw', name: 'DW', price: 1.85, weight: 0, volume: 0, discountPercent: 0, showOnOrderList: true, cxPrice: null, category: 'liquids' },
  { id: 'demo-ove', name: 'OVE', price: 2.40, weight: 0, volume: 0, discountPercent: 0, showOnOrderList: true, cxPrice: null, category: 'food' },
  { id: 'demo-h2o', name: 'H2O', price: 0.45, weight: 0, volume: 0, discountPercent: 0, showOnOrderList: true, cxPrice: null, category: 'liquids' },
  { id: 'demo-fe', name: 'FE', price: 6.10, weight: 0, volume: 0, discountPercent: 0, showOnOrderList: true, cxPrice: null, category: 'metals' },
  { id: 'demo-c', name: 'C', price: 2.75, weight: 0, volume: 0, discountPercent: 0, showOnOrderList: true, cxPrice: null, category: 'elements' },
  { id: 'demo-al', name: 'AL', price: 8.90, weight: 0, volume: 0, discountPercent: 0, showOnOrderList: true, cxPrice: null, category: 'metals' },
  { id: 'demo-si', name: 'SI', price: 5.30, weight: 0, volume: 0, discountPercent: 0, showOnOrderList: true, cxPrice: null, category: 'elements' },
  { id: 'demo-lst', name: 'LST', price: 4.15, weight: 0, volume: 0, discountPercent: 0, showOnOrderList: true, cxPrice: null, category: 'minerals' },
  { id: 'demo-hal', name: 'HAL', price: 22.60, weight: 0, volume: 0, discountPercent: 0, showOnOrderList: true, cxPrice: null, category: 'minerals' },
];
...
function buildDemoOrders(){
  ...
  const templates = [
    ...
    { id: 'demo_ord_3', username: 'orbit', customerName: 'ZQP', contact: 'orbit#7712', pickupLocation: 'Benten', note: 'Leave at dock 3.', currency: 'NCC', status: 'production', sellerComment: 'On the line now, ETA 2 days.', handledBy: 'Saganaki', createdAt: hoursAgo(20), confirmedAt: hoursAgo(18), productionAt: hoursAgo(10), items: [mat('demo-al', 150, 90), mat('demo-lst', 60, 60), mat('demo-hal', 12, 4)] },
